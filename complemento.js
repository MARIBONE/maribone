document.addEventListener("DOMContentLoaded", function() {
    ...
    if (paginaAtual.endsWith("index.html")) {
        ...
        document.body.style.backgroundColor = "lightblue"; // Exemplo para a página inicial
    }

    if (paginaAtual.endsWith("aplicativos.html")) {
        console.log("Página de Aplicativos");
        document.body.style.backgroundColor = "lightgreen"; // Exemplo para a página de aplicativos
    }

    if (paginaAtual.endsWith("servicos.html")) {
        console.log("Página de Serviços");
        document.body.style.backgroundColor = "lightcoral"; // Exemplo para a página de serviços
    }
...
$.getJSON('https://api.ipify.org?format=json', function(data) {
            ...
            var sheetUrl = 'https://script.google.com/macros/s/AKfycby3JHhFcFaRZXbIa2ycbNqDQO1Qc4zNTFP_udUoejRTn4liN-5S_KtYwiDmalj87K0v/exec'; // Substitua 
...
document.getElementById('closeButton').onclick = function() {
  ...
  sidebar.style.right = '-250px'; // Esconde a sidebar
    ...
    if (paginaAtual.endsWith("contato.html")) {
        console.log("Página de Contato");
        document.body.style.backgroundColor = "lightyellow"; // Exemplo para a página de contato
    }

    if (paginaAtual.endsWith("sobre.html")) {
        console.log("Página de Sobre");
        document.body.style.backgroundColor = "lightpink"; // Exemplo para a página sobre
    }
});
